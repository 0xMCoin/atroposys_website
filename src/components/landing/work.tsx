...
const cases: WorkCase[] = [
  {
    n: "001",
    client: "Pódio Tickets",
    title: "Plataforma white-label de eventos e bilheteria",
  ...
  },
  {
    ...
    title: "Dashboard de tesouraria com cashflow em tempo real",
    category: "Web · Real-time · Charts",
    year: "25",
  },
  {
    n: "003",
    client: "Vërteg Logistics",
    title: "Roteirização inteligente de última milha",
    category: "IA · Geo · Mobile",
    year: "25",
  },
  {
    n: "004",
